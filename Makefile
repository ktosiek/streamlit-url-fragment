...
python_sources = $(wildcard streamlit_url_fragment/*.py) pyproject.toml
...
build: \
	streamlit_url_fragment/build/index.html \
	dist/streamlit-url-fragment-$(version).tar.gz \
	dist/streamlit_url_fragment-$(version)-py3-none-any.whl
